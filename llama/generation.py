...
class Llama:
    ...
    def build(
        ...
        Args:
            ...
            model_parallel_size (Optional[int], optional): Number of model
                parallel processes. If not provided, it's determined from
        ...
        Raises:
            AssertionError: If there are no checkpoint files in the specified
                directory, or if the model parallel size does not match the
    ...
    def generate(
        ...
        Note:
            ...
            randomness. If logprobs is True, token log probabilities are
            computed for each generated token.
    ...
    def text_completion(
        ...
        Args:
            ...
            max_gen_len (Optional[int], optional): Maximum length of the
                ...
                If not provided, set to the model's max. sequence length -1.
        ...
        Note:
            ...
            If logprobs is True, token log probabilities are computed for
    ...
    def chat_completion(
        ...
        Args:
            ...
            top_p (float, optional): Top-p probability threshold for nucleus
                sampling. Defaults to 0.9.
            max_gen_len (Optional[int], optional): Maximum length of the
                generated response sequence. If not provided, it's set to the
                model's maximum sequence length minus 1.
            logprobs (bool, optional): Flag indicating whether to compute
                token log probabilities. Defaults to False.
        ...
        Raises:
            AssertionError: If the last message in a dialog is not from the
                user.
            AssertionError: If the dialog roles are not in the required
                'user', 'assistant', and optional 'system' order.

        Note:
            This method generates assistant responses for the provided
            conversational dialogs. It employs nucleus sampling to introduce
            controlled randomness in text generation. If logprobs is True,
            token log probabilities are computed for each generated token.
